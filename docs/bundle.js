(() => {
  ...
  function j(n2, u2, i2, t2, o2, r2, f2, e2, c2) {
    var s2, h2, v2, y2, p, k2, b2, m2, g2, x2, A, P2, C2, $2 = u2.type;
    ...
    try {
      n:
        if (typeof $2 == "function") {
          if (m2 = u2.props, g2 = (s2 = $2.contextType) && t2[s2.__c], x2 = s2 ? g2 ? g2.props.value : s2.__ : t2, i2.__c ? b2 = (h2 = u2.__c = i2.__c).__ = h2.__E : ("prototype" in $2 && $2.prototype.render ? u2.__c = h2 = new $2(m2, x2) : (u2.__c = h2 = new _(m2, x2), h2.constructor = $2, h2.render = O), g2 && g2.sub(h2), h2.props = m2, h2.state || (h2.state = {}), h2.context = x2, h2.__n = t2, v2 = h2.__d = true, h2.__h = []), h2.__s == null && (h2.__s = h2.state), $2.getDerivedStateFromProps != null && (h2.__s == h2.state && (h2.__s = a({}, h2.__s)), a(h2.__s, $2.getDerivedStateFromProps(m2, h2.__s))), y2 = h2.props, p = h2.state, v2)
          ...
          if (h2.context = x2, h2.props = m2, h2.__v = u2, h2.__P = n2, A = l.__r, P2 = 0, "prototype" in $2 && $2.prototype.render)
            h2.state = h2.__s, h2.__d = false, A && A(u2), s2 = h2.render(h2.props, h2.state, h2.context);
          else
            do {
              h2.__d = false, A && A(u2), s2 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
            } while (h2.__d && ++P2 < 25);
          h2.state = h2.__s, h2.getChildContext != null && (t2 = a(a({}, t2), h2.getChildContext())), v2 || h2.getSnapshotBeforeUpdate == null || (k2 = h2.getSnapshotBeforeUpdate(y2, p)), C2 = s2 != null && s2.type === d && s2.key == null ? s2.props.children : s2, w(n2, Array.isArray(C2) ? C2 : [C2], u2, i2, t2, o2, r2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
        } else
  ...
  var App = class extends _ {
    ...
    render() {
      ...
      }, this.getModeName()), this.state.status && /* @__PURE__ */ v("div", {
        className: `status ${this.state.statusClass}`
      }, this.state.status));
    }
    changeMode() {
    ...
    select(option) {
      if (this.state.pick === option) {
        this.setState(this.nextState(void 0, "Good job!", "success"), () => {
          this.readWord();
        });
      } else {
  ...
  // src/index.tsx
  S(/* @__PURE__ */ v(App, null), document.getElementById("content"));
})();
